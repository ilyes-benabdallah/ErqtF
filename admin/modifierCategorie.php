...
if(isset($_GET['cat']))
{
	...
	$nomCategorie = $categorie['nom_categorie'];			
			...
			<h3>Catégorie <small>Modifier l'image de la catégorie</small> <small><a href="categoriesProduit.php#produit"><span class="label label-primary">Afficher les catégories</span></a></small></h3>
			<br>
				...
				<form action="modifierCategorie.php?cat=<?php echo $moncat; ?>#produit" enctype="multipart/form-data" method="POST">
					...
					<br><br>
					<div class="form1">
					<button type="submit" name="modifier" class="btn btn-primary btn-block" >Modifier l'image de la categorie</button>
					</div>
				</form>
				</div>
