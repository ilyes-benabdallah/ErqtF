...
if (isset ($_POST['ajouter']))
{
							...
							$content_dir = '../image/gallery/'; // dossier où sera déplacé le fichier
									...
									$type_file = $_FILES['ImageNews']['type'];
											...
											$requeteAjouterSlide= mysql_query("INSERT INTO gallery (image_gallery) VALUE('$name_file1')") or die(mysql_error());
											
													
											//header("location:afficherSlide.php#slide");
											echo "<script>window.location.replace('afficherGallery.php#gallery');</script>";
...
?>
   <div class="text-left" href="#gallery">
	<h3>Gallery <small>Ajouter une image a la gallery</small></h3>


	<form action="ajouterImageGallery.php#gallery" enctype="multipart/form-data" method="POST">
