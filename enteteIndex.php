...
<meta name="description" content="www.eurequat-algerie.com: comment creer son site web">
...
<body>
	...
	<div class="divWidth">
		...
		<!--div class="divActualiteWidth">
			<div class="main-wrapper">
			<?php
			
			
			//include('actualiteAccueil1.php');
